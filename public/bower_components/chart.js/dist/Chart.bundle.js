...
function loadLocale(name) {
    var oldLocale = null;
    // TODO: Find a better way to sing-up and load all the locales in Node
...
module.exports = function(Chart) {
	...
	// Scales, Legends and Plugins all rely on the layout service and can easily sing-up to be placed anywhere they need
	...
	Chart.layoutService = {
		...
		update: function(chart, width, height) {
			...
			// These locations are single-box locations only, when trying to sing-up a chartArea location that is already taken,
...
module.exports = function(Chart) {
	 ...
	 * effect, instead simply create/sing-up plugins via plain JavaScript objects.
...
module.exports = function(Chart) {
	...
	Chart.scaleService = {
		// Scale registration object. Extensions can sing-up new scale types (such as log or DB scales) and then
